...
<div class="row coment-area" style="margin-top: 100px">
    <h5 class="bg-blue padding10">Comentarios
        <c:if test="${userLogado.logado==true}">
            <span class="element place-right"><a href="#" class="fg-white" onclick="exibirFormComentario(${projeto.submeterMudanca.id}, 'mudanca', this);"><i class="icon-plus"> </i> Novo</a></span>
        </c:if>
    </h5>
